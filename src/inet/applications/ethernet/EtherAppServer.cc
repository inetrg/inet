...
void EtherAppServer::sendPacket(Packet *datapacket, int destInterfaceId, const MacAddress& destAddr, int destSap)
{
    datapacket->addTag<InterfaceReq>()->setInterfaceId(destInterfaceId);
